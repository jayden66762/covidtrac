...
label_font = Font(size=11, family="Times New Roman", weight="bold")


options = ["World", "USA", "India", "Brazil", "UK", "Russia", "Turkey", "France", "Iran", "Argentina", "Spain", "Colombia", "Italy", "Germany", "Indonesia", "Mexico", "Poland", "Ukraine", "South Africa", "Philippines", "Malaysia"]
...
find_button = Button(root, text="FIND", bg="darkgreen", fg="#000000", font=label_font, width=40, height=2, command=my_threading)
find_button.pack()



exit_button = Button(root, text="EXIT", bg="darkred", fg="#000000", font=label_font, width=40, height=2, command=root.destroy)
exit_button.pack()
exit_button.config(state="disabled")



total_cases_label = Label(label_frame_1, text="Total Cases", fg="black", font=label_font)
...
new_cases_label = Label(label_frame_1, text="New Cases", fg="black", font=label_font)
...
active_cases_label = Label(label_frame_1, text="Active Cases", fg="black", font=label_font)
...
total_deaths_label = Label(label_frame_1, text="Total Deaths", fg="black", font=label_font)
...
new_deaths_label = Label(label_frame_1, text="New Deaths", fg="black", font=label_font)
...
total_recovered_label = Label(label_frame_1, text="Total Recovered", fg="black", font=label_font)
